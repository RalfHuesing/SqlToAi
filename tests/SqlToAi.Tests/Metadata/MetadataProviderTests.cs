...
public sealed class MetadataProviderTests
{
    ...
    private sealed class MockMetadataConnection : DbConnection
    {
    ...
    private sealed class MockMetadataCommand : DbCommand
    {
        private readonly string _tableDesc;
        private readonly Dictionary<string, string> _columnDescs;
    ...
    private sealed class MockTableDataReader : DbDataReader
    {
    ...
    private sealed class MockColumnDataReader : DbDataReader
    {

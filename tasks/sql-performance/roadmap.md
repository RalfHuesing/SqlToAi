...
- [x] EPIC-04: Dokumentation — `mcp-specification.md` §14 + §15 aktualisieren (Betrifft: docs/mcp-specification.md §14 sql_measure_performance, §15 sql_benchmark_optimization, §12 sql_execute_query) — erledigt in `step-004` (Verdict: approved; Tech-Debt TD-001 notiert: mcp-specification.md komplett Deutsch statt Englisch, vorbestehend, außerhalb Scope)

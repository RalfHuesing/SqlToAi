...
- **`tests/SqlToAi.Tests/Database/`** — `*ServiceTests` (DRY-T3 33 redundante Guardrail-Negativ-Tests), `QueryExecutionServiceMockDb`, `SchemaServiceMockDb`, `PerformanceMeasurementServiceTests` (DRY-T2 8 duplizierte ShowPlan-XML-Blöcke), `OptimizationBenchmarkServiceTests` (MV-2 Testseite).

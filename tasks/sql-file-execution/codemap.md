...
- **`src/SqlToAi/Database`** — database execution services, connection/command helpers, safety validation, transaction integrity, parameter binding, performance metrics, and local script intake used by the batch execution engine.
